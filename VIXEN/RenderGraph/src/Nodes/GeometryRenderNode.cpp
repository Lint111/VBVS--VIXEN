...
void GeometryRenderNode::SetupImpl(TypedNode<GeometryRenderNodeConfig>::TypedSetupContext& ctx) {
    // Graph-scope initialization only (no input access)
    NODE_LOG_DEBUG("GeometryRenderNode: Setup (graph-scope initialization)");
}

void GeometryRenderNode::CompileImpl(TypedNode<GeometryRenderNodeConfig>::TypedCompileContext& ctx) {
...
void GeometryRenderNode::ExecuteImpl(TypedNode<GeometryRenderNodeConfig>::TypedExecuteContext& ctx) {
...
void GeometryRenderNode::CleanupImpl(TypedNode<GeometryRenderNodeConfig>::TypedCleanupContext& ctx) {
