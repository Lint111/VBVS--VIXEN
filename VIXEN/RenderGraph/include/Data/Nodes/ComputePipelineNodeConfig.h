...
CONSTEXPR_NODE_CONFIG(ComputePipelineNodeConfig,
    ...
    INPUT_SLOT(SHADER_DATA_BUNDLE, std::shared_ptr<ShaderManagement::ShaderDataBundle>, 1,
        SlotNullability::Required,
        SlotRole::Dependency,
        SlotMutability::ReadOnly,
        SlotScope::NodeLevel);
    ...
    VALIDATE_NODE_CONFIG(ComputePipelineNodeConfig, ComputePipelineNodeCounts);
