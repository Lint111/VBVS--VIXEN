#ifndef VIXEN_BODY_FOOTPRINT_REGIME_GLSL
#define VIXEN_BODY_FOOTPRINT_REGIME_GLSL

// Keep these values in lockstep with Recipe/BodyFootprintRegime.h.  The classifier uses
...
// Values mirror BodyFootprintRegime's explicit underlying values:
// 0 = SurfaceDetail, 1 = Orbital, 2 = System, 3 = DeepField.
uint classifyBodyFootprintRegime(float cameraDistance, float bodyRadius) {
