...
struct Metadata {
    static constexpr const char* PROGRAM_NAME = "VoxelRayMarch_Compressed";
    static constexpr const char* INTERFACE_HASH = "1e1a7e31f1a81721";
