...
namespace ShaderInterface { namespace ExposureTonemap {
...
struct Metadata { static constexpr const char* PROGRAM_NAME="ExposureTonemap"; static constexpr uint32_t NUM_MEMBERS=2; static constexpr uint32_t NUM_FEATURES=0; };
namespace Bind { struct sceneRadianceHistory { static constexpr uint32_t SET=0, BINDING=0; }; struct outputImage { static constexpr uint32_t SET=0, BINDING=1; }; }
