...
//
// E13-T1 (2026-08-10): hand-authored, matching the missing-generated-header
// pattern E11-T1 fixed for cosmicK — HitAccumClear.comp/BuildRenderGraph.cpp's
// #include "merged/HitAccumClear-SDI.h" was never regenerated after batch-26
// added the shader (sdi_tool is not present in this tree). Shape verified
// against HitAccumClear.comp (single std430 buffer HitAccumTable, binding=0,
// no push constants) and HitAccumulate-SDI.h's own HitAccumTable member
// (LAYOUT_HASH/SIZE copied verbatim — same struct, same shader family).
//
// ============================================================================
