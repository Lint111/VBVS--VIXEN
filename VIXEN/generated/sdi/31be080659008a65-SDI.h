...
/**
 * @brief BrickDataBuffer
 * Size: 0 bytes
 * Alignment: 16 bytes
 * Layout VixenHash: 0x880b3c0756d4e2cf (for runtime discovery)
 */
struct BrickDataBuffer {
    // Phase H: Discovery system layout hash
    static constexpr uint64_t LAYOUT_HASH = 0x880b3c0756d4e2cfULL;
...
namespace Set0 {
    ...
    struct Binding3 {
        ...
        static constexpr uint32_t COUNT = 1;
        static constexpr VkShaderStageFlags STAGES = VK_SHADER_STAGE_ALL;
        using DataType = BrickDataBuffer;
    };
...
struct Metadata {
    ...
    static constexpr const char* INTERFACE_HASH = "67c0863013082b51";
