...
- **Inc-3 — C# data-upload API (face 3).** When undertow is reachable: generated typed C# setters over the SoA bridge. (Absorbs the old doc's "data→view provenance" Inc-3.)

- **Inc-4 — view→action (face 4): the AppFlow convergence.** See §7.

- **Inc-5+ — editor-HUD migration; undertow adoption.**
