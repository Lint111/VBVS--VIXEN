...
**Status:** DIRECTION (user-proposed 2026-07-04, mid widescreen-perf program). Not scheduled; natural next epic after the widescreen close-out — it is the real fix for the deferred "many-bodies bandwidth" items (Widescreen findings ranks 4/5/6/10) and the enabler for undertow's 60-300-body path and provider-LOD (AR#41/48).
