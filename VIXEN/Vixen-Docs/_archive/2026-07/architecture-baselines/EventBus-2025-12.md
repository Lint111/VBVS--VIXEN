...
> ⚓ **ARCHIVED BASELINE 2026-08-12.** This page documents obsolete `EventBus.h`/`Event.h` examples and
> an obsolete main-thread-only claim. The maintained replacement is
> [`EventBus.md`](../../../Libraries/EventBus.md).
