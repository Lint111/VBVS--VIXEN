...
> ⚓ **ARCHIVED BASELINE 2026-08-12.** The planned local `ViewSchema.cs` and engine-submodule schema
> topology was superseded. Undertow now invokes the kernel tool directly; the View ledger is derived from
> `schemas.json` queries and facets, and VIXEN consumes committed Undertow artifacts through the
> superproject. See [`Undertow-VIXEN-Federation-2026-08.md`](../../../01-Architecture/Undertow-VIXEN-Federation-2026-08.md).
