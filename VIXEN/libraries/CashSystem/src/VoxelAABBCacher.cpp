...
void VoxelAABBCacher::Cleanup() {
    ...
    // Free all cached buffer allocations via FreeBufferTracked. Walks the published generation
    // (teardown is the quiescent point; the walk holds nothing), then Clear() below retires it.
